...
//            LAA_8_CTA20131112_ZHENGSUZHI_v1.stl
            ...
            if (i == 1)
                stl_filename = QString("%1\\CM_%2_%3_predictionv1_sim.stl").arg(stl_path).arg(QString::number(i)).arg(
                        casename);
            if (i == 2)
                stl_filename = QString("%1\\LA_%2_%3_predictionv1_sim.stl").arg(stl_path).arg(QString::number(i)).arg(
                        casename);
            if (i == 3)
                stl_filename = QString("%1\\LV_%2_%3_predictionv1_sim.stl").arg(stl_path).arg(QString::number(i)).arg(
                        casename);
            if (i == 4)
                stl_filename = QString("%1\\RA_%2_%3_predictionv1_sim.stl").arg(stl_path).arg(QString::number(i)).arg(
                        casename);
            if (i == 5)
                stl_filename = QString("%1\\RV_%2_%3_predictionv1_sim.stl").arg(stl_path).arg(QString::number(i)).arg(
                        casename);
            if (i == 6)
                stl_filename = QString("%1\\AT_%2_%3_predictionv1_sim.stl").arg(stl_path).arg(QString::number(i)).arg(
                        casename);
            if (i == 7)
                stl_filename = QString("%1\\PA_%2_%3_predictionv1_sim.stl").arg(stl_path).arg(QString::number(i)).arg(
                        casename);
        }
