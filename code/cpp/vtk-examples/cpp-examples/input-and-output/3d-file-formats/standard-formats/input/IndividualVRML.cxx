...
//    }
    ...
    string filename1 = DATAPATH + "teapot.wrl";
    string filename2 = DATAPATH + "teapot";
//    string argv[2] = {filename1.c_str(),filename2.c_str() };
    const char *argv[2] = { "E:\\data\\medicaldata\\vtk\\vtp\\Testing\\Data\\teapot.wrl","E:\\data\\medicaldata\\vtk\\vtp\\Testing\\Data\\teapot"};
    std::string filename = argv[1];
    std::cout << "Showing " << argv[2] << " from " << filename << std::endl;
//    std::string filename = filename1;
//    std::cout << "Showing " << filename2 << " from " << filename << std::endl;
